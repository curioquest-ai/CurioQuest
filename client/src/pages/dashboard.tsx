    ...
    <div className="h-screen w-full bg-background overflow-y-auto safe-area-inset">
      <div className="p-6 pb-24">
        ...
        <div className="grid grid-cols-2 gap-4 mb-6">
          ...
          >
            <Card className="bg-gradient-to-br from-secondary to-secondary/80 border-none text-secondary-foreground">
              <CardContent className="p-4">
                <div className="flex items-center justify-between">
                  <div>
          ...
          >
            <Card className="bg-gradient-to-br from-accent to-accent/80 border-none text-accent-foreground">
              <CardContent className="p-4">
                <div className="flex items-center justify-between">
                  <div>
                    <p className="text-accent-foreground/80 text-sm">Videos Watched</p>
          ...
          >
            <Card className="bg-gradient-to-br from-success/80 to-success border-none text-white">
              <CardContent className="p-4">
                <div className="flex items-center justify-between">
                  <div>
                    <p className="text-white/80 text-sm">Quiz Accuracy</p>
